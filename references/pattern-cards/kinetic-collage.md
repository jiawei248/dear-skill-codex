...
This card is a high-quality reference, not a fixed script. Codex may borrow only the collage composition logic, the alignment discipline, the editorial image curation, the restrained motion strategy, or the atmosphere-building method, remix it with other patterns, and change copy, composition, assets, and tone freely.
