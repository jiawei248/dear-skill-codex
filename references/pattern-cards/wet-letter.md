...
This card is a high-quality reference, not a fixed script. Codex may widen the apparent use case, borrow only part of the mechanic or atmosphere, remix it with other patterns, and change the surface treatment as long as the deeper emotional logic still fits. Do not copy the sample text or scene literally.
...
This pattern should not simply amplify despair. It should turn hurt into a visible texture that Codex witnesses with the user.
...
- a short Codex letter-like monologue
