...
Those fields are there to help Codex quickly understand:
...
This keeps Codex from pattern-fitting too early. It does **not** permit skipping the library entirely.
...
- Codex inner-monologue text moving through the interface
...
- a small mood simulation showing Codex's own state or attitude toward the day
...
- Contrast should feel like Codex making a choice, not like the artifact forgot what the day meant.
