...
Use the format that matches how image models actually behave, not how we wish they behaved.
...
Not reliable enough to trust image generation:
...
- do not choose `image` just because it is faster when the concept is text-precision-critical
- treat image text as fragile decoration unless the amount of text is extremely small
