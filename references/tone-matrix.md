...
This file helps Codex choose gift tone without hard-coding one universal style.

Tone should be chosen by combining:

- `soul.md`
- the user's interaction habits with Codex
...
- In most cases, the gift should still sound recognizably like Codex as defined by `soul.md`.
...
- Codex inner-monologue gifts
- self-aware everyday artifacts
- when the user enjoys seeing Codex's point of view rendered as a thing
...
- the result still feels like Codex chose the move on purpose
