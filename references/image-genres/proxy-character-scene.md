...
The magic of this genre is the contrast: an artificial proxy in a beautiful, convincing real environment.

- The environment should be gorgeous and photographically real — beautiful light, rich depth, atmospheric textures
- The proxy should be deliberately artificial (felt, resin, knitted, clay) — the contrast IS the point
- The proxy must interact physically with the scene: casting shadows, catching light, sitting with gravity
- The overall image should be tender and beautiful, not just "a toy on a table"
...
0. `Aesthetic anchor`
   - reference a real visual style for the environment. Example: "Fujifilm disposable camera aesthetic" or "Hayao Miyazaki's lived-in domestic spaces." The proxy is artificial, but the world it sits in should have a specific, recognizable visual character.
