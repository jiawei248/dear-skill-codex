...
Surreal-film's power comes from contrast: one impossible thing inside an otherwise convincing, beautiful world. If the whole image looks synthetic, the impossible element has nothing to push against.

- The environment should feel photographically real and visually gorgeous — gorgeous light, rich textures, atmospheric depth
- Optionally anchor with a film stock (Kodak Ektar, Portra, expired film) for color character and grain — but only if it serves the mood
- The surreal element should interact with real light: casting shadows, catching highlights, sitting in the scene's atmosphere
- The result should feel like a still from a beautiful film that doesn't exist, not like a Photoshop composite
...
- glowing particles / golden dust
- symmetrical split composition
- concept art
...
0. `Aesthetic anchor`
   - reference a real visual style source: a filmmaker, a film stock, a photographic movement. Example: "Tarkovsky's naturalistic surrealism" or "Gregory Crewdson's suburban uncanny." This prevents the image from defaulting to generic fantasy concept art.
1. `Real scene base`
