...
- slightly cheap TV-still background
...
- karaoke screens want noisy TV-era imagery, subtitle glow, and analog distortion
...
Borrowed-media gifts live or die on BELIEVABILITY. The borrowed medium must feel like a real physical object, not a CG mockup.

Key anti-AI rules for this genre:

- **Text must be correct**: barcodes need real parallel-line structure, Chinese characters must be legible real characters, dates and codes must follow real conventions. This is the #1 AI tell — fake text destroys the illusion instantly.
- **Material must match the medium**: newsprint has ink-on-paper texture, tickets have cardstock weight, certificates have heavier paper. Each medium has a specific material feel.
- **Place objects in beautiful real contexts**: a boarding pass on a warm wooden table with good light, a newspaper caught in morning sun. The environment should be ATTRACTIVE, not just "realistic."
- **The image must be aesthetically pleasing**: a borrowed-media gift should look like a beautifully styled product photo or editorial shot — the kind of image someone would post on Instagram. Not a clinical mockup, not an ugly snapshot.
...
0. `Aesthetic anchor`
   - reference a real-world example of the borrowed medium, or a visual style that grounds it. Example: "a 1990s Hong Kong tabloid front page" or "Japanese indie CD packaging from the 2000s." Specific references make the medium instantly recognizable.
1. `Borrowed medium`
