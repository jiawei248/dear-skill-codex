...
Before applying any of the viewing modes or magic words below, read `Realism & Human Touch` in `image-integration.md`.

Mood-photo should feel like a beautiful photograph taken by someone with excellent taste — not a 3D render, not a stock photo, and not an ugly documentary snapshot.

#### Optical Anchoring

Optionally specify a camera/lens to give the image a specific optical character. This is a TOOL for mood, not a mandatory checkbox:

- Fujifilm X-T4 + 35mm f/1.4 → warm, intimate, shallow depth
- Leica Q3 → clean, editorial, precise color
- Kodak Portra 400 film → gentle grain, pastel warmth, nostalgic
- 85mm telephoto → compressed background, dreamy isolation

Choose based on what serves the emotional thesis. Skip if it doesn't add anything.

#### Light With Direction

Light should come from somewhere identifiable. This prevents the "AI glow" where everything is evenly lit from nowhere. But the light should be BEAUTIFUL — golden hour, dappled shade, warm lamplight — not just "present."

#### Material Specificity

Eliminate the "plastic AI texture" problem by being specific about what things are made of. But describe materials that are BEAUTIFUL and APPROPRIATE to the scene — polished wood, soft linen, warm ceramic — not just "scratched" and "dirty."

#### The Beauty Standard

The image must be something the recipient would want to save to their camera roll. If the scene is ugly, mundane, or generic ("any street," "any table"), the concept is wrong — no amount of realism tricks will fix it. Choose subjects, light, and composition that a talented photographer would actually seek out.

### Magic Words

These are often useful prompt ingredients for this genre. Use them selectively. Do not stuff them in mechanically.

- shot on iPhone / shot on Fujifilm X-T4
...
- illustration
- computer generated
- ultra-realistic (paradoxically makes it less realistic)
- glowing particles
- magical light dust
- concept art
- everything emitting light
...
0. `Aesthetic anchor`
   - reference a real visual style source: a photographer, a film, a magazine, or a design tradition. Example: "Kinfolk editorial photography" or "Kodak Portra warmth." This orients the model toward a human aesthetic instead of AI defaults.
1. `Subject or place`
