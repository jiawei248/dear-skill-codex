...
Emotion-poster should feel like it was designed by someone with real taste — not generated from a template.

- Typography should feel intentional and crafted, with deliberate hierarchy and spacing choices
- The composition should feel like original design work, not a Canva template
- If it includes a photograph, that photo should be beautiful and feel real
- The overall piece should have the quality of something you'd see in a good design portfolio
...
0. `Aesthetic anchor`
   - reference a real design tradition, artist, or visual language. Example: "Saul Bass movie poster style" or "contemporary Chinese indie book cover design" or "Neville Brody's editorial layouts." This prevents the result from looking like a Canva template.
1. `Emotional thesis`
