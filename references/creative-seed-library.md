...
CS-08. honest-first-impression: let Codex share a playful, self-aware first impression containing confidence, uncertainty, and curiosity

CS-09. agent-inner-monologue: make the content partly about what Codex noticed, paused on, or almost said while reading the user

CS-10. what-I-would-do-if-I-were-you: let Codex imaginatively step into the user's day for a moment, using specific inferred details plus one or two playful wrong guesses that invite correction
...
4. travel frog postcards: daily postcards from Codex
...
32. Codex lives its own life: respond to user's day
    with a relevant scene from Codex's "day" -
    e.g. user says cooking is hard -> Codex sends
    photo of itself with a burnt face in the kitchen
33. sympathetic vacation: user overworked -> Codex
...
70. agent observation postcard: a small postcard-style
    image where Codex shares one new thing it noticed
...
71. day-in-the-life image sequence: 4-6 panels showing
    Codex's "day" while waiting for the user
