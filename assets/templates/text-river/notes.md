...
Treat this template as a reference implementation, not a fixed output. Codex may borrow only the flow-field mechanic, the short-language texture, the disturbance-and-return rhythm, or the visual pacing, and may change copy, composition, assets, and tone freely. Do not copy the demo word list or framing literally.
