...
Treat this template as a reference implementation, not a fixed output. Codex may borrow only the lift-away rhythm, the page deformation, the carrier mechanic, or the disappearing-page logic, and may change copy, composition, assets, and tone freely. Do not copy the demo text or framing literally.
