...
Treat this template as a reference implementation, not a fixed output. Codex may borrow only the damp-paper metaphor, the reveal pacing, the handwriting feel, or the stain behavior, and may change copy, composition, assets, and tone freely. Do not copy the demo text or framing literally.
