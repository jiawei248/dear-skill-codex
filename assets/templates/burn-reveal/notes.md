...
Treat this template as a reference implementation, not a fixed output. Codex may borrow only the reveal logic, the edge treatment, the before-and-after structure, or the pacing of transformation, and may change copy, composition, assets, and tone freely. Do not copy the demo text or framing literally.
