...
Treat this template as a reference implementation, not a fixed output. Codex may borrow only the reveal mechanic, the pacing, the layering idea, or the atmosphere, and may change copy, composition, assets, and tone freely. Do not copy the demo text or framing literally.
