...
Treat this template as a reference implementation, not a fixed output. Codex may borrow only the dispersion mechanic, the page texture, the pacing, or the overall emotional handling, and may change copy, composition, assets, and tone freely. Do not copy the demo text or framing literally.
